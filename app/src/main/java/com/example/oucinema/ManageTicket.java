            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.nav_manager_Film:
                        Intent intent = new Intent(ManageTicket.this, ManageFilm.class);
                        intent.putExtra("user_name",user_name);
                        intent.putExtra("user_id",user_id);
                        startActivity(intent);
                        break;
                    case R.id.nav_manager_t:
                        Intent intent_ticket = new Intent(ManageTicket.this, ManageTicket.class);
                    ...
                    case R.id.nav_manager_static:
                        Intent intent_setfilm = new Intent(ManageTicket.this, Statis.class);
                    ...
                    case R.id.nav_manager_user:
                        Intent intent_user = new Intent(ManageTicket.this, ManageUser.class);
